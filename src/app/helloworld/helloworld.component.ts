...
@Component({ // Decorator é uma classe que altera uma outra classe. É um componente que altera um componente original. A partir do momento que a classe "HelloWorldComponent" recebeu o componente, ele passou a ser um componente Angular
...
Depois deve-se importar os componentes criados no app.component.ts
